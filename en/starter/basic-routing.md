...
This tutorial assumes that an instance of `express` named `app` is created and the server is running. If you are not familiar with creating an app and starting it, see the [Hello world example](/{{ page.lang }}/{{ page.lang }}/starter/hello-world.html).
</div>
...
For more details about routing, see the [routing guide](/{{ page.lang }}/{{ page.lang }}/guide/routing.html).
