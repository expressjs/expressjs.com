...
Notice that when _not_ calling "next" in an error-handling function, you are responsible for writing (and ending) the request. Otherwise those requests will "hang" and will not be eligible for garbage collection. 
