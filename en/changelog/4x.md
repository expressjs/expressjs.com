...
The 4.15.5 patch release includes some minor performance enhancements and a minor
bug fix:
...
<ul>
  ...
  <li markdown="1" class="changelog-item">
  Parsing conditional headers (like `If-None-Match`) is faster.
  </li>
</ul>
...
The 4.15.3 patch release includes a security updated and some minor bug fixes:
