...
This should not affect your code if you follow the Express 4 documentation of [app.param](/api/application/app-param), as it makes no mention of the leading colon.
