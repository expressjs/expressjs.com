...
The [Express application generator](/en/starter/generator) uses [Pug](https://pugjs.org/api/getting-started) as its default, but it also supports [Handlebars](https://www.npmjs.com/package/handlebars), and [EJS](https://www.npmjs.com/package/ejs), among others.
