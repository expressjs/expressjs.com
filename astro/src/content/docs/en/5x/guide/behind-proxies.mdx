...
<ul>
  <li markdown="1">
    The value of [req.hostname](/en/api/request/req-hostname) is derived from the value set in the
  ...
  <li markdown="1">
    ...
    [req.protocol](/en/api/request/req-protocol).
  </li>
  <li markdown="1">
    The [req.ip](/en/api/request/req-ip) and [req.ips](/en/api/request/req-ips) values are populated
    based on the socket address and `X-Forwarded-For` header, starting at the first untrusted
    address.
  </li>
</ul>
