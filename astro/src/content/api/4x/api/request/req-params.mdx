...
If you need to make changes to a key in `req.params`, use the [app.param](/api/application/app-param) handler. Changes are applicable only to [parameters](/guide/routing#route-parameters) already defined in the route path.
