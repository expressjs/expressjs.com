...
[Sequelize.js](https://sequelize.org/), qui est un nœud. s / io.js ORM pour PostgreSQL, MySQL, SQLite et MSSQL.
...
[![Ω][sequelstore-connect-image] sequelstore-connect][sequelstore-connect-url] Un magasin de session utilisant [Sequelize.js](https://sequelize.org/).
