...
sera enregistrée même si le serveur plante, _mais les données de la réponse (comme le code de réponse
, la longueur du contenu, etc.) ne peut pas être logged_.
