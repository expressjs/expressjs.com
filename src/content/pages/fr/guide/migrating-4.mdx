...
<ul class="docliste">
  <li>
    <a href="#core-changes">Changement de coeur et de système middleware Express.</a> Les
    dépendances de Connect et les middleware intégrés ont été supprimées, vous devez donc ajouter du
    middleware vous-même.
  </li>
  <li>
