...
[Sequelize.js](https://sequelize.org/), che è un Node. s / io.js ORM per PostgreSQL, MySQL, SQLite e MSSQL.
...
[![★][sequelstore-connect-image] sequelstore-connect][sequelstore-connect-url] Un negozio di sessione che utilizza [Sequelize.js](https://sequelize.org/).
