...
Potresti avere familiarità con la crittografia Secure Socket Layer (SSL). In generale, si consiglia Nginx per gestire TLS. In altre parole, se si utilizza SSL prima, considerare l'aggiornamento a TLS. In altre parole, se si utilizza SSL prima, considerare l'aggiornamento a TLS. Per un buon riferimento per configurare TLS su Nginx (e altri server), vedere [Configurazioni server consigliate (Mozilla Wiki)](https://wiki.mozilla.org/Security/Server_Side_TLS#Recommended_Server_Configurations).
