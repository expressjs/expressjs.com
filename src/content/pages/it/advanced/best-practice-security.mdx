...
Assicurati inoltre di non utilizzare nessuna delle versioni Express vulnerabili elencate nella [pagina Aggiornamenti di sicurezza](/advanced/security-updates). Se lo si è, aggiornare a una delle versioni stabili, preferibilmente l'ultimo.
...
[aggiungendo il tuo gestore non trovato](/starter/faq#how-do-i-handle-404-responses)
e
[scrivendo il tuo gestore di errore](/guide/error-handling#writing-error-handlers):
