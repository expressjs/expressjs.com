...
[Sequelize.js](https://sequelize.org/), que es un Nodo. s / ORM io.js para PostgreSQL, MySQL, SQLite y MSSQL.
...
[![Ninguno][sequelstore-connect-image] sequelstore-connect][sequelstore-connect-url] Una tienda de sesiones con [Sequelize.js](https://sequelize.org/).
