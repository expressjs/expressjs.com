...
<MiddlewareInfo version="0.1.0" github="https://github.com/expressjs/session" npm="https://www.npmjs.com/paquete/sesión" />
...
**Nota** Los datos de la sesión *no* se guardan en la cookie misma, sólo el ID de la sesión.
...
it to be saved. *Esto ha sido arreglado en PassportJS 0.3.0*
