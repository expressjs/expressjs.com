...
El comité técnico Express consta de miembros activos del proyecto, y guía el desarrollo y el mantenimiento del proyecto Express. Para obtener más información, consulte [Comunidad Express - Comité Técnico](/resources/community/#technical-committee).
...
[el documento del proceso de la prueba](https://github.com/expressjs/discussions/blob/master/docs/contributing/triager-guide.md).
