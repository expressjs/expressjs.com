...
<ul class="doklist">
  ...
  <li>
    <a href="#example-migration">Ein Beispiel</a> für die Migration einer Express 3 App auf Express
    4.
  </li>
  <li>
...
<ul class="doklist">
  <li>
    <a href="#core-changes">Änderungen des Express-Core- und Middleware-Systems.</a> Die
    Abhängigkeiten von Connect und eingebauter Middleware wurden entfernt, daher müssen Sie selbst
