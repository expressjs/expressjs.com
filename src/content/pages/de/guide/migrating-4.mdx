...
| `app.configure()`                  | Die Funktion `app.configure()` wurde entfernt. Use the `process.env.NODE_ENV` or `app.get('env')` function to detect the environment and configure the app accordingly. |
| `json spaces`                      | The `json spaces` application property is disabled by default in Express 4.                                                                                             |
| `req.accepted()`                   | Benutze `req.accepts()`, `req.acceptsEncodings()`, `req.acceptsCharsets()` und&#xA;`req.acceptsLanguages()`.                                                            |
...
| `res.charset`                      | Removed.                                                                                                                                                                |
| `res.setHeader('Set-Cookie', val)` | Die Funktionalität ist nun auf das Setzen des grundlegenden Cookie-Wertes beschränkt. Use `res.cookie()` for added functionality.                                       |
