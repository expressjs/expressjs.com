...
Ein Beispiel für potenziell gefährliche Benutzereingaben ist eine *open redirect*, wo eine Anwendung akzeptiert eine URL als Benutzereingabe (oft in der URL-Abfrage, zum Beispiel `?url=https://example.com`) und verwendet `res.redirect` um den `location` Header und
