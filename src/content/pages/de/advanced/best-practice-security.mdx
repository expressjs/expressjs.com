...
Ein Beispiel für potenziell gefährliche Benutzereingaben ist eine _open redirect_, wo eine Anwendung akzeptiert eine URL als Benutzereingabe (oft in der URL-Abfrage, zum Beispiel `?url=https://example.com`) und verwendet `res.redirect`, um den `location`-Header und
...
geändert werden [füge deinen eigenen nicht gefundenen Handler hinzu](/starter/faq#how-do-i-handle-404-responses)
und
[deinen eigenen Fehler zu schreiben](/guide/error-handling#writing-error-handlers):
