...
[![★][dynamodb-store-v3-image] dynamodb-store-v3][dynamodb-store-v3-url] Implementierung eines Session-Shops mit DynamoDB unterstützt durch das [AWS SDK für JavaScript v3](https://github.com/aws/aws-sdk-js-v3).
...
[![★][sequelstore-connect-image] sequelstore-connect][sequelstore-connect-url] Ein Session-Shop mit [Sequelize.js](http://sequelizejs.com/).
...
[![★][@cyclic.sh/session-store-image] @cyclic.sh/session-store][@cyclic.sh/session-store-url] Ein DynamoDB-basierter Session Store für [Cyclic.sh](https://www.cyclic.sh/) Apps.
