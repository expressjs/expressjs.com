...
<MiddlewareInfo version="0.1.0" github="https://github.com/express js/Sitzung" npm="https://www.npmjs.com/package/session" />
...
**Notiz** Sitzungsdaten werden *nicht* im Cookie selbst gespeichert, nur die Session-ID.
...
gespeichert wird. *Dies wurde in PassportJS 0.3.0* behoben
