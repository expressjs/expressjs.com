...
<MiddlewareInfo
  version="2.8.6"
  github="https://github.com/expresjs/cors"
...
`cors` does not include its own TypeScript type definitions. If you use TypeScript, also install the community-maintained types from [DefinitelyTyped](https://github.com/DefinitelyTyped/DefinitelyTyped) as a development dependency:

<PackageManagerCommand command="npm install --save-dev @types/cors" />

</Alert>

## Auslastung

### Einfache Nutzung (Aktiviere _All_ CORS-Anfragen)
