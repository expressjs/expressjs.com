...
in `req.session` Objekt speichern und validieren Sie es auf dem Server und implementieren Sie jede andere Logik
...
Inhalt in der Sitzung, also sollten Sie etwas zu `req.session` sobald
