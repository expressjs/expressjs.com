...
Per rendere i file dei modelli, imposta le seguenti [proprietà delle impostazioni dell'applicazione](/api#app.set), nel file `app.js` predefinito creato dal generatore:
