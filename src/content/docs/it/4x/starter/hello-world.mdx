...
&mdash; _non_ quello che si otterrebbe se si utilizza il [Express generator](/starter/generator), che
...
Crea prima una directory chiamata `myapp`, cambiala ed esegui `npm init`. Quindi, installa `express` come dipendenza, secondo la [guida all'installazione](/starter/installing).
