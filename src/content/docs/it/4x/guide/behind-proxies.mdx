...
<ul>
  <li markdown="1">
    Il valore di [req.hostname](/api#req.hostname) è derivato dal valore impostato nell'intestazione
  ...
  <li markdown="1">
    I valori [req.ip](/api#req.ip) e [req.ips](/api#req.ips) sono popolati in base all'indirizzo del
    socket e all'intestazione `X-Forwarded-For`, a partire dal primo indirizzo non fidato.
  </li>
</ul>
