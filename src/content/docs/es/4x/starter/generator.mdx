...
Por ejemplo, lo siguiente crea una aplicación Express llamada *myapp*. La aplicación se creará en una carpeta llamada *myapp* en el directorio de trabajo actual y el motor de vistas se establecerá en <a href="https://pugjs.org/" target="_blank" title="Pug documentation">Pug</a>:
