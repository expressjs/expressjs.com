...
Para más información sobre el argumento `options`, vea [express.static](/en/5x/api#express.static).
...
Para crear un prefijo de ruta virtual (donde la ruta no existe en el sistema de archivos) para archivos que son servidos por el `express. función tatic`, [especificar una ruta de montaje](/en/5x/api#app.use) para el directorio estático, como se muestra a continuación:
...
Para más detalles sobre la función `serve-static` y sus opciones, vea [serve-static](/en/resources/middleware/serve-static).
