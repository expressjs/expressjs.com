...
<ul>
  ...
  <li markdown="1">
    Los valores [req.ip](/en/api#req.ip) y [req.ips](/en/api#req.ips) son poblados según la
    dirección del socket y la cabecera `X-Forwarded-For`, comenzando en la primera dirección no
    confiable.
  </li>
</ul>
