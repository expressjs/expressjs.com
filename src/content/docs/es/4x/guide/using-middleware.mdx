...
- [express.static](/api#express.static) sirve activos estáticos como archivos HTML, imágenes, etc.
- [express.json](/api#express.json) analiza las solicitudes entrantes con cargas útiles JSON. **NOTA: Disponible con Express 4.16.0+**
- [express.urlencoded](/api#express.urlencoded) analiza las solicitudes entrantes con payloads codificados por URL. **NOTA: Disponible con Express 4.16.0+**
