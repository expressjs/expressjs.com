...
<div class="callout" id="callout5">
  HTTP <a href="/en/5x/api#res">argumento</a> de respuesta a la función de middleware, llamada "res"
  por convención .
</div>

<div class="callout" id="callout6">HTTP <a href="/en/5x/api#req">solicita un argumento</a> a la función de middleware, llamado "req" por convención.</div>
</td>
</tr>
</table>
</div>
