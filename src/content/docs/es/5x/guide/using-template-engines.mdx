...
Para renderizar archivos de plantilla, establezca las siguientes [propiedades de configuración de aplicación](/api#app.set), en el `app.js` por defecto creado por el generador:
