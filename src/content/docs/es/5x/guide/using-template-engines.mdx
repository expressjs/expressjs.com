...
El [generador de aplicaciones Express](/starter/generator) utiliza [Pug](https://pugjs.org/api/getting-started.html) como predeterminado, pero también soporta [Handlebars](https://www.npmjs.com/package/handlebars), y [EJS](https://www.npmjs.com/package/ejs), entre otros.

Para renderizar archivos de plantilla, establezca las siguientes [propiedades de configuración de aplicación](/4x/api#app.set), en el `app.js` por defecto creado por el generador:
