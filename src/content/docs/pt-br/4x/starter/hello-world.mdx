...
&mdash; _não_ o que você obteria se usar o [Express generator](/starter/generator), que
...
Primeiro, crie um diretório chamado `myapp`, mude para ele e execute `npm init`. Em seguida, instale `express` como uma dependência, conforme o [guia de instalação](/starter/installing).
