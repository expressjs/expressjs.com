...
<div class="callout" id="callout5">
  HTTP <a href="/5x/api#res">resposta</a> argumento para a função middleware, chamada de "res" pela
  convenção .
</div>

<div class="callout" id="callout6">HTTP <a href="/5x/api#req">request</a> argumento para a função middleware, chamado de "req" pela convenção.</div>
</td>
</tr>
</table>
</div>
...
Para mais informações sobre Express middleware, veja: [Usando Express middleware](/guide/using-middleware).
