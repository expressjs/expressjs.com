...
Executar este comando no aplicativo padrão gerado pelo [gerador expresso](/en/starter/generator) imprime a seguinte saída:
...
[`util.inspect()`](https://nodejs.org/api/util#util_util_inspect_object_options) para a lista
completa.
