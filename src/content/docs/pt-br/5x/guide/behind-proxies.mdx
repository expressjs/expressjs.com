...
<ul>
  <li markdown="1">
    O valor de [req.hostname](/api#req.hostname) é derivado do valor definido no cabeçalho
  ...
  <li markdown="1">
    Os valores [req.ip](/api#req.ip) e [req.ips](/api#req.ips) são preenchidos com base no cabeçalho
