...
[app.METHOD](/en/5x/api/application#appmethodpath-callback--callback-) を参照してください。 [app.all()](/en/5x/api/application#appallpath-callback--callback-)を使用して、すべてのHTTPメソッドと[app]を処理することもできます。 se()](/en/5x/api/application#appusepath-callback--callback) to
...
| 方法                                                                         | 説明                                                                               |
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| [res.download()](/en/5x/api/response#resdownloadpath--filename--options--fn) | ダウンロードするファイルを指示します。                                             |
| [res.end()](/en/5x/api/response#resenddata-encoding-callback)                | 応答プロセスを終了します。                                                         |
| [res.json()](/en/5x/api/response#resjsonbody)                                | JSON 応答を送信します。                                                            |
| [res.jsonp()](/en/5x/api/response#resjsonpbody)                              | JSONP サポートを使用して JSON 応答を送信します。                                   |
| [res.redirect()](/en/5x/api/response#resredirectstatus-path)                 | リダイレクトします。                                                               |
| [res.render()](/en/5x/api/response#resrenderview--locals--callback)          | ビューテンプレートをレンダリングします。                                           |
| [res.send()](/en/5x/api/response#ressendbody)                                | さまざまなタイプの応答を送信します。                                               |
| [res.sendFile()](/en/5x/api/response#ressendfilepath--options--fn)           | ファイルをオクテットストリームとして送信する。                                     |
| [res.sendStatus()](/en/5x/api/response#ressendstatusstatuscode)              | レスポンスステータスコードを設定し、文字列表現をレスポンスボディとして送信します。 |
