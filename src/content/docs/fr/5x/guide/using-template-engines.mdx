...
Pour afficher les fichiers de gabarit, définissez les [propriétés de réglage de l'application](/api#app.set), dans le `app.js` par défaut créé par le générateur:
