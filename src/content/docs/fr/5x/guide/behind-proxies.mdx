...
<ul>
  <li markdown="1">
    La valeur de [req.hostname](/en/api#req.hostname) est dérivée de la valeur définie dans
    l'en-tête `X-Forwarded-Host`, qui peut être définie par le client ou par le proxy.
  </li>
  <li markdown="1">
  ...
  <li markdown="1">
    Les valeurs [req.ip](/en/api#req.ip) et [req.ips](/en/api#req.ips) sont remplies en fonction de
