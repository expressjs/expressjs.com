...
<ul>
  <li markdown="1">
    The value of [req.hostname](/api#req.hostname) is derived from the value set in the
  ...
  <li markdown="1">
    ...
    address and `X-Forwarded-For` header, starting at the first untrusted address.
  </li>
</ul>
