...
&mdash; _not_ what you'd get if you use the [Express generator](/en/4x/starter/generator), which
...
First create a directory named `myapp`, change to it and run `npm init`. Then, install `express` as a dependency, as per the [installation guide](/en/4x/starter/installing).
