...
For an introduction to routing, see [Basic routing](/en/5x/starter/basic-routing).
...
specify middleware as the callback function (See [Using middleware](/en/5x/guide/using-middleware) for details).
...
See the [path route matching syntax](/en/guide/migrating-5#path-route-matching-syntax) for more information.
