...
Zum Beispiel erstellt das Folgende eine Express-App namens _myapp_. Die App wird in einem Ordner namens _myapp_ im aktuellen Arbeitsverzeichnis erstellt und die View Engine wird auf <a href="https://pugjs.org/" target="_blank" title="Pug documentation">Pug</a> gesetzt:
