...
Um Template-Dateien zu rendern, setzen Sie folgende [Anwendungs-Einstellungen-Eigenschaften](/api#app.set), in der Standardeinstellung `app.js`, die vom Generator erstellt wurde:
