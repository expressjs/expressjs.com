...
QUERY support requires **Node.js >= 21.7.2** and it is stable on Node.js >= 22.
...
should not appear in server logs or browser history, or require a structured body format such as JSON.
