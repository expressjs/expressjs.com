...
cycle, if any. Otherwise this API is identical to [app.locals](/api/application/#applocals).
...
Later you may access this value through the [req.signedCookie](/api/request/#reqsignedcookies)
object.
...
however you may alter this with the [jsonp callback name](/api/application/#settings)
