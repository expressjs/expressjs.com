...
<div class="methods-columns">
  <ul>
    ...
    <li>
      <a href="#appdelete"><code>delete</code></a>
    </li>
    <li>
      <a href="#appget"><code>get</code></a>
    </li>
    <li>
      <code>head</code>
    </li>
  ...
  <ul>
    ...
    <li>
      <a href="#apppost"><code>post</code></a>
    </li>
  </ul>
  <ul>
    <li>
    ...
    <li>
      <a href="#appput"><code>put</code></a>
    </li>
    <li>
      <a href="#appquery"><code>query</code></a> (Node.js &gt;= 22.0.0)
    </li>
    <li>
      <code>report</code>
    </li>
...
QUERY support requires **Node.js >= 22.0.0**.
