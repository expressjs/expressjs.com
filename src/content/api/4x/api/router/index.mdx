...
authRouter.get('/:user_id/edit', function (req: Request, res: Response, next: NextFunction) {
  // ... Edit user UI ...
});
openRouter.get('/', function (req: Request, res: Response, next: NextFunction) {
  // ... List users ...
});
openRouter.get('/:user_id', function (req: Request, res: Response, next: NextFunction) {
  // ... View user ...
});
