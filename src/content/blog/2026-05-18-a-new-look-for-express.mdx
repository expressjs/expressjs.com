...
Under the hood, we moved from Jekyll to [Astro](https://astro.build), chosen after a long [community discussion](https://github.com/expressjs/expressjs.com/discussions/2019) weighing tradeoffs and long-term maintenance. It gave us the flexibility we needed for content-heavy pages, strong performance, solid i18n support, and a component model that doesn't lock us into a single UI framework.
...
The new site is designed to make contributing easier than ever. If you spot something that could be better, an unclear explanation, a missing example, or a translation that needs love, please [open an issue or a pull request](https://github.com/expressjs/expressjs.com).
...
The effort was led by [Sebastian Beltran](https://github.com/bjohansebas), with [Francesca Giannino](https://github.com/g-francesca) driving much of the design and UI work across the new site, and [Angela Angelini](https://www.linkedin.com/in/angeliningl/) and [Davide Spaziani](https://www.linkedin.com/in/davidespazianitesta/) leading the brand workshop that shaped the new visual identity.
