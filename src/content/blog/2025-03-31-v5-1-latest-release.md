...
from the project this past year, we have been [hard at work reviving the project](/blog/2025-01-09-rewind-2024-triumphs-and-2025-vision/)
...
You can find our [v5 docs](/5x/api) and our [migration guide](/guide/migrating-5) on the website.
...
However, we understand that not all changes can be automated. Some breaking changes, such as the [new Path Route Matching syntax](/guide/migrating-5#path-route-matching-syntax), require manual modifications by developers. You can read more about all of the breaking changes which came with v5 in our [original release announcement](/blog/2024-10-15-v5-release).

For more details on the migration process and how to use the codemod package, check the [repository’s README](https://github.com/expressjs/codemod#readme) and the [migration guide](/guide/migrating-5).

### Ecosystem compatibility

The Express ecosystem is one of its strongest assets. It goes back to the early days of Node.js and is the backbone
that keeps express popular. When it goes [10 years without a major release](/blog/2024-10-15-v5-release)
...
Additionally since then [we have announced a partnership with HeroDevs](/blog/2024-10-01-herodevs-partnership-announcement) to help companies who are less capable of
...
- [router@2.2.0](https://github.com/pillarjs/router/releases/tag/v2.2.0)
  ...
  - Remove `after`, `safe-buffer`, `array-flatten`, `setprototypeof`, `methods`, `utils-merge`
