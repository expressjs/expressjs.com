...
Express 5 is a breaking change from Express 4. That means an existing Express 3 app will not work if you update the Express version in its dependencies.
